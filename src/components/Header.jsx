    ...
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm border-b border-orange-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-[4rem] flex items-center justify-between gap-4">
        ...
        {viewMode === 'map' ? (
          <div className="flex-1 max-w-md relative transition-all animate-slide-down">
            ...
            <input
              ...
              className="block w-full pl-10 pr-4 py-2.5 rounded-full border-2 border-orange-100 bg-white text-gray-900 placeholder:text-gray-500 focus-visible:ring-2 focus-visible:ring-orange-500 focus:outline-none focus:border-orange-400 text-sm font-medium shadow-sm transition-all duration-300"
        ...
        <button 
          ...
          className="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white px-4 md:px-6 py-2.5 rounded-full font-bold transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 shrink-0 focus-visible:ring-2 focus-visible:ring-orange-500 outline-none"
        >
